...
public class ControllerYear_1Mid {
   ...
   private PreparedStatement ps;
    ...
    public void initialize()  {
        ...
        try {
            ...
            while (rs.next()){
                if (rs.getInt(5)==1&&rs.getInt(6)==1) {
        ...
        sub3.setBackground(new Background(new BackgroundFill(Color.LIGHTBLUE, CornerRadii.EMPTY, Insets.EMPTY)));
