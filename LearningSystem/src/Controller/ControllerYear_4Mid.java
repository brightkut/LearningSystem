...
public class ControllerYear_4Mid {
    ...
    public void initialize()  {
        ...
        try {
            ...
            while (rs.next()){
                if (rs.getInt(5)==1&&rs.getInt(6)==4) {
        ...
        sub2.setBackground(new Background(new BackgroundFill(Color.LIGHTBLUE, CornerRadii.EMPTY, Insets.EMPTY)));
        sub3.setBackground(new Background(new BackgroundFill(Color.LIGHTGREEN, CornerRadii.EMPTY, Insets.EMPTY)));
