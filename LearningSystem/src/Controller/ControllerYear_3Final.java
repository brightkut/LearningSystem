...
public class ControllerYear_3Final {
    ...
    public void initialize()  {
        ...
        try {
            ...
            while (rs.next()){
                if (rs.getInt(5)==2&&rs.getInt(6)==3) {
        ...
        sub5.setBackground(new Background(new BackgroundFill(Color.LIGHTBLUE, CornerRadii.EMPTY, Insets.EMPTY)));
