...
public class ControllerYear_1Final {
    ...
    public void initialize()  {
        ...
        try {
            ...
            while (rs.next()){
                if (rs.getInt(5)==2&&rs.getInt(6)==1) {
        ...
        sub4.setBackground(new Background(new BackgroundFill(Color.LIGHTGREEN, CornerRadii.EMPTY, Insets.EMPTY)));
        ...
        sub7.setBackground(new Background(new BackgroundFill(Color.LIGHTBLUE, CornerRadii.EMPTY, Insets.EMPTY)));
